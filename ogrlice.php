...
<section id="products">
    <div class="product-list">
        ...
        <div class="product-item">
            <img src="neso.jpg" alt="Ruby ogrlica">
            <h3>Ruby ogrlica</h3>
            <p>Cena: 23,500 RSD</p>
            <form action="korpa.php" method="POST">
                <input type="hidden" name="sifra_proizvoda" value="4">
                <input type="hidden" name="naziv" value="Ruby">
                <input type="hidden" name="cena" value="23500">
        ...
        <!-- Drugi proizvod -->
        <div class="product-item">
            <img src="royal.jpg" alt="Royal ogrlica">
            <h3>Royal ogrlica</h3>
            <p>Cena: 40,000 RSD</p>
            <form action="korpa.php" method="POST">
                <input type="hidden" name="sifra_proizvoda" value="5">
                <input type="hidden" name="naziv" value="Royal">
                <input type="hidden" name="cena" value="40000">
                <input type="submit" name="kupi" value="Dodaj u korpu">
            </form>
        </div>
        ...
        <!-- Treći proizvod -->
        <div class="product-item">
            <img src="modern.jpg" alt="Modern ogrlica">
            <h3>Modern ogrlica</h3>
            <p>Cena: 32,500 RSD</p>
            <form action="korpa.php" method="POST">
                <input type="hidden" name="sifra_proizvoda" value="6">
                <input type="hidden" name="naziv" value="Modern">
                <input type="hidden" name="cena" value="32500">
                <input type="submit" name="kupi" value="Dodaj u korpu">
            </form>
        </div>
    </div>
