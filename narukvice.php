...
<section id="products">
    <div class="product-list">
        ...
        <div class="product-item">
            <img src="desire.jpg" alt="Desire narukvica">
            <h3>Desire narukvica</h3>
            <p>Cena: 42,300 RSD</p>
            <form action="korpa.php" method="POST">
                <input type="hidden" name="sifra_proizvoda" value="1">
                <input type="hidden" name="naziv" value="Desire">
                <input type="hidden" name="cena" value="42300">
        ...
        <!-- Drugi proizvod -->
        <div class="product-item">
            <img src="elegance.jpg" alt="Elegance narukvica">
            <h3>Elegance narukvica</h3>
            <p>Cena: 75,000 RSD</p>
            <form action="korpa.php" method="POST">
                <input type="hidden" name="sifra_proizvoda" value="2">
                <input type="hidden" name="naziv" value="Elegance">
                <input type="hidden" name="cena" value="75000">
                <input type="submit" name="kupi" value="Dodaj u korpu">
            </form>
        </div>
        ...
        <!-- Treći proizvod -->
        <div class="product-item">
            <img src="ametist.jpg" alt="Classic narukvica">
            <h3>Classic narukvica</h3>
            <p>Cena: 39,900 RSD</p>
            <form action="korpa.php" method="POST">
                <input type="hidden" name="sifra_proizvoda" value="3">
                <input type="hidden" name="naziv" value="Classic narukvica">
                <input type="hidden" name="cena" value="39900">
                <input type="submit" name="kupi" value="Dodaj u korpu">
            </form>
        </div>
