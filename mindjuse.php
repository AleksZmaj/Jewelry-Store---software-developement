...
<header>
<img src="slika.jpg" alt="Pozadina headera" class="footer-img">
    <h1>Zlatara</h1>
</header>
...
<section id="products">
    <div class="product-list">
        ...
        <div class="product-item">
            <img src="Kusadasi.jpg" alt="Kusadasi mindjuse">
            <h3>Kusadasi mindjuse</h3>
            <p>Cena: 235,000 RSD</p>
            <form action="korpa.php" method="POST">
                <input type="hidden" name="sifra_proizvoda" value="10">
                <input type="hidden" name="naziv" value="Kusadasi">
                <input type="hidden" name="cena" value="235000">
        ...
        <!-- Drugi proizvod -->
        <div class="product-item">
            <img src="sparkle.jpg" alt="Sparkle mindjuse">
            <h3>Sparkle mindjuse </h3>
            <p>Cena: 90,000 RSD</p>
            <form action="korpa.php" method="POST">
                <input type="hidden" name="sifra_proizvoda" value="11">
                <input type="hidden" name="naziv" value="Sparkle">
                <input type="hidden" name="cena" value="90000">
                <input type="submit" name="kupi" value="Dodaj u korpu">
            </form>
        </div>
        ...
        <!-- Treći proizvod -->
        <div class="product-item">
            <img src="queen.jpg" alt="Queen mindjuse">
            <h3>Queen mindjuse</h3>
            <p>Cena: 54,000 RSD</p>
            <form action="korpa.php" method="POST">
                <input type="hidden" name="sifra_proizvoda" value="12">
                <input type="hidden" name="naziv" value="Queen">
                <input type="hidden" name="cena" value="54000">
                <input type="submit" name="kupi" value="Dodaj u korpu">
            </form>
        </div>
    </div>
